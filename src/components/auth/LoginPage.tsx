...
import { LogIn, User, Key, ArrowRight, Shield, Github } from 'lucide-react';
        ...
        {!isAdminLogin && (authSettings.google || authSettings.github) && (
          <>
            ...
            <div className="flex items-center justify-center space-x-4">
              {authSettings.google && (
                <motion.button type="button" className="w-12 h-12 flex items-center justify-center bg-premium-dark-gray border border-white/10 rounded-full hover:border-premium-gold/50" whileHover={{scale: 1.05}} whileTap={{scale: 0.95}}>
                  <GoogleIcon />
                </motion.button>
              )}
              {authSettings.github && (
                <motion.button type="button" className="w-12 h-12 flex items-center justify-center bg-premium-dark-gray border border-white/10 rounded-full text-premium-light-gray hover:border-premium-gold/50 hover:text-white" whileHover={{scale: 1.05}} whileTap={{scale: 0.95}}>
